...
function _createContacts() {
	let contacts = storageService.load(STORAGE_KEY_CONTACT)
	if (!contacts || !contacts.length) {
		contacts = [
			{
				...
				imgId: utilService.getRandomInt(0, 99),
			},
			{
			...
			},
			{
				...
				imgId: utilService.getRandomInt(0, 9),
			},
			{
		...
		storageService.save(STORAGE_KEY_CONTACT, contacts)
	}
}
